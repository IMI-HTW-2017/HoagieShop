...
class SubsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub" do
    assert_difference('Sub.count') do
      post subs_url, params: { sub: { bread_id: @sub.bread_id, main_ingredient_id: @sub.main_ingredient_id, order_id: @sub.order_id, sauce_id: @sub.sauce_id } }
    end
  ...
  test "should update sub" do
    patch sub_url(@sub), params: { sub: { bread_id: @sub.bread_id, main_ingredient_id: @sub.main_ingredient_id, order_id: @sub.order_id, sauce_id: @sub.sauce_id } }
