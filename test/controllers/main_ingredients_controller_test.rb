...
class MainIngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main_ingredient" do
    assert_difference('MainIngredient.count') do
      post main_ingredients_url, params: { main_ingredient: { count: @main_ingredient.count, name: @main_ingredient.name } }
    end
  ...
  test "should update main_ingredient" do
    patch main_ingredient_url(@main_ingredient), params: { main_ingredient: { count: @main_ingredient.count, name: @main_ingredient.name } }
